...
def create_mock_objects():
    Student('David', 'student', 'Ll111111')
    ...
    Professor('Robert', 'professor', 'Fd549875')
    ...
    Course('Algorithms', 'al101', 25, 'Linda', 20, ['mt223'])
    ...
    Course('Machine Learning', 'ml808', 30, 'William', 25, ['ds123', 'al101'])
    Course('Cloud Computing', 'cc909', 25, 'Elizabeth', 20, ['os202'])
